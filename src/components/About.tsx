...
const About = () => {
    return (
        <div className="bg-black text-white min-h-screen" id="about">
            <Navbar />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div className="order-2 md:order-1">
                            ...
                            <p className="text-lg text-white/80 mb-6">
                                A Storm surgiu da necessidade de trazer mais grafite e arte de rua para o streetwear, fugindo das estampas genéricas que saturam o mercado. Com essa ideia resgatada do passado, a marca nasceu para entregar originalidade em cada estampa, aliando estilo e qualidade nos tecidos..</p>
                            <p className="text-lg text-white/80 mb-6">
